...
{{def_kernel("Q", "K", "V", "LSE", "KV_NUM_BLKS", "KV_IDX", "FULL_KV_NUM_BLKS", "FULL_KV_IDX")}}
    ...
    if USE_TMA:
        TMA_SIZE = 128
        desc_m_stride = 3 * TMA_SIZE
        BH_stride = tl.num_programs(0) * desc_m_stride
        BH_NUM = tl.program_id(1)
        workspace_base = ws_ptr + q_start * desc_m_stride + BH_NUM * BH_stride
...
def flex_attention(
    ...
    for BLOCK_M, BLOCK_N, num_warps, num_stages in configs:
        ...
        # Collecting input shapes required for calculating num_programs
        batch_size, num_heads, _, head_dim = query.get_size()
        ...
        error = flex_attention_template.maybe_append_choice(
            ...
            workspace_arg=get_tma_workspace_arg(
                ...
                device=query.get_device(),
                num_programs=(
                    (num_heads + cur_kernel_options["BLOCK_M"] - 1)
